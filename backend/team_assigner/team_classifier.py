...
from transformers import SiglipVisionModel, SiglipImageProcessor, logging as transformers_logging
from umap import UMAP
from more_itertools import chunked
from typing import List, Tuple
from development_and_analysis.k_means_custom import CustomKMeans

# Suppress UNEXPECTED key warnings from SigLIP
...
class TeamAssigner:
    def __init__(self, device: str = 'cpu', video_path=None):
        ...
        # ignore_mismatched_sizes removes UNEXPECTED warnings
        ...
        if self.stub_path and os.path.exists(self.stub_path):
            try:
                ...
                if not isinstance(data, dict):
                    print(f" Unexpected data format in {self.stub_path}. Resetting assignments.")
                    data = {}
                ...
                print(f" Error loading team assignments: {e}. Starting fresh.")
                self.player_team_mapping = {}
                self.player_feature_cache = {}
        else:
